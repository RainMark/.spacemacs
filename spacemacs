...
values."
  (setq-default
   ...
   '(
     ...
     ;; ----------------------------------------------------------------
     ;; (helm :variables
     ;;       hybrid-mode-enable-hjkl-navigation t)
     helm
     ;; auto-completion
     ;; better-defaults
     emacs-lisp
...
you should place your code here."
  ;; (setenv "PATH" (concat (getenv "PATH") ":/usr/local/bin:/usr/bin:/bin:/usr/sbin:/sbin:/Users/rain/Project/apache-maven-3.5.4/bin"))
  ;; (setq exec-path (append exec-path '("/usr/local/bin")))
  ;; (setq shell-file-name "/bin/sh")
  ;; just fixed in .zshenv
